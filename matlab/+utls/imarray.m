...
%   J=IMARRAY(A) creates a mosaic J from the array of images A. A
...
% Torn apart with the VLFeat by Karel Lenc
% Copyright (C) 2007-12 Andrea Vedaldi and Brian Fulkerson.
% All rights reserved.
%
% This file is part of the VLFeat library and is made available under
% the terms of the BSD license (see the vlfeat_LICENSE.txt file).

p = inputParser();
addOptional(p, 'reverse', false, @islogical);
addOptional(p, 'movie', false, @islogical);
addOptional(p, 'spacing', 0, @(x) x >= 0);
