...
bnames{end+1} = struct('name', 'kde', 'printname', '\kde', 'texname', 'KDE', ...
  ...
  'dim', 147, 'isbin', false, 'psize', 65, 'pps', 2157, 'gpu', false, 'normname', normname);
...
bnames_pca{end+1} = struct('name', 'kde', 'printname', '\pkde', 'texname', '+KDE', ...
  'color', in_c(utls.rgb('Teal'), cip), 'barargs', {ls}, ...
  'normname', norms{'kde', 'normstr'}{1});
