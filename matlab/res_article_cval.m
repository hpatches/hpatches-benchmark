...
bnames{end+1} = struct('name', 'tfeat-n-lib', 'printname', '\tfn', 'texname', 'TF', ...
  ...
  'dim', 128, 'isbin', false, 'psize', 32, 'pps', 1./10e-6, 'gpu', true);
...
bnames{end+1} = struct('name', 'tnet', 'printname', '\tnet', 'texname', 'TNet', ...
  'color', in_c(utls.rgb('Chocolate'), cip), 'barargs', {ls}, ...
  'dim', 128, 'isbin', false, 'psize', nan, 'pps', nan, 'gpu', true);
bnames{end+1} = struct('name', 'l2net', 'printname', '\l2net', 'texname', 'L2-Net', ...
  'color', in_c(utls.rgb('Maroon'), cip), 'barargs', {ls}, ...
  'dim', 128, 'isbin', false, 'psize', nan, 'pps', nan, 'gpu', true);
bnames{end+1} = struct('name', 'HardNetLib', 'printname', '\hardnet', 'texname', 'HardNet', ...
  'color', in_c(utls.rgb('Tan'), cip), 'barargs', {ls}, ...
  'dim', 128, 'isbin', false, 'psize', nan, 'pps', nan, 'gpu', true);
bnames{end+1} = struct('name', 'HardNetLib+', 'printname', '\hardnetplus', 'texname', 'HardNetE', ...
  'color', in_c(utls.rgb('Wheat'), cip), 'barargs', {ls}, ...
  'dim', 128, 'isbin', false, 'psize', nan, 'pps', nan, 'gpu', true);
...
bnames_pca{end+1} = struct('name', 'tnet-norm', 'printname', '\ptnet', 'texname', '+TNet', ...
  'color', in_c(utls.rgb('Chocolate'), cip), 'barargs', {ls});
bnames_pca{end+1} = struct('name', 'l2net-norm', 'printname', '\pl2net', 'texname', '+L2-Net', ...
  'color', in_c(utls.rgb('Maroon'), cip), 'barargs', {ls});
bnames_pca{end+1} = struct('name', 'HardNetLib-norm', 'printname', '\phardnet', 'texname', '+HardNet', ...
  'color', in_c(utls.rgb('Tan'), cip), 'barargs', {ls});
bnames_pca{end+1} = struct('name', 'HardNetLib+-norm', 'printname', '\phardnetplus', 'texname', '+HardNetE', ...
  'color', in_c(utls.rgb('Wheat'), cip), 'barargs', {ls});
